package com.print.test.PrinterControl;
...
public class BixolonPrinter implements ErrorListener, OutputCompleteListener, StatusUpdateListener, DirectIOListener, DataListener {
    ...
    public void directIOOccurred(DirectIOEvent directIOEvent) {
        //         Fragment fm = MainActivity.Companion.getVisibleFragment();
       /* if (fm != null) {
    ...
    public void errorOccurred(ErrorEvent errorEvent) {
        setDeviceLog("Error : " + errorEvent);
    }

    @Override
    public void outputCompleteOccurred(OutputCompleteEvent outputCompleteEvent) {
        setDeviceLog("outputComplete : " + outputCompleteEvent.getOutputID());
    }

    @Override
    public void statusUpdateOccurred(StatusUpdateEvent statusUpdateEvent) {
        setDeviceLog(getSUEMessage(statusUpdateEvent.getStatus()));
    }
